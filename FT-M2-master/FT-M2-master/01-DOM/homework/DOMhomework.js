...
// Tu código acá:
var creacion = document.querySelector('#createdBy')
creacion.innerHTML= "Creado Por Emiliano Lopez Filippini "
...
function buildToDo(todo, index) {
 ...
 toDoText.id = index
  if (toDoText.complete ==True) toDoText.classList.add="completeText"
